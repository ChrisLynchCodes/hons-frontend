...
import { editAdmin } from "../../Context/Admin/AdminActions";
...
export const EditAdminForm = ({ admin }) => {
  ...
  const onSubmit = async (data) => {
    ...
    await editAdmin(adminId, admin, cookies.token)
    ...
    <>
      ...
      <div className="form-control">
        ...
        <div className="form-control">
                    ...
                    <input {...register("imageLink", { required: true, minLength: 5, maxLength: 200 })} defaultValue={admin.imageLink} onChange={(e) => (setImageLink(e.target.value))} type="text" placeholder="Image Link" className="input input-bordered input-primary" />
